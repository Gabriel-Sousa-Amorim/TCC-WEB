//Botão Remover
document.getElementsByName("TypeForms").forEach((i) =>
...
document
    .getElementById("Nome-Voluntario")
...
function ValidaIdade(x) {
    ...
    if (
        dataAtual.getFullYear() > dataNasc.getFullYear() &&
...
document
    .getElementById("Telefone-Voluntario")
    .addEventListener("blur", function () {
        ValidaTelefone(document.getElementById("Telefone-Voluntario"));
    });
document
    .getElementById("Telefone-Doador")
    .addEventListener("blur", function () {
...
document
    .getElementById("Email-Voluntario")
    .addEventListener("blur", function () {
...
function ValidaImagem(x) {
    const ImageExp = new RegExp(/.*\.(jpe?g|png|)$/gim);
    x.classList.remove("is-valid");
    x.classList.remove("is-invalid");
...
document
    .getElementById("Distritos-Input-Search")
    .addEventListener("blur", function () {
...
document
    .getElementById("unidade-doador")
    .addEventListener("change", function () {
        ValidaRegião(document.getElementById("unidade-doador"));
    });

document
    .getElementById("Doador-Enable")
    .addEventListener("change", function () {
...
document
    .getElementById("Voluntario-Enable")
    .addEventListener("change", function () {
